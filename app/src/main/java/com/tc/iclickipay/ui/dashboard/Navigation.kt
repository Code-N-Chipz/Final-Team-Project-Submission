...
import com.tc.delivery.ui.navigation.DeliveryApp
...
fun AppNavHost() {
    ...
    NavHost(navController = navController, startDestination = "dashboard") {
        ...
        composable("screen_tinder") { SimpleScreen("Tinder Screen") }
        ...
        composable("screen_delivery") { DeliveryApp(parentNavController = navController) }
