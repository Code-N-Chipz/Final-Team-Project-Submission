package com.tc.delivery.ui.deliverystartingpage
...
import com.tc.delivery.ui.comon.PrimaryButtonColour

@Composable
fun DeliveryStartPage(
    ...
    Column(
        ...
        Image(
            painter = painterResource(R.drawable.delivery_start_page),
        ...
        PrimaryButtonColour(
            ...
            text = R.string.delivery_lets_go_button_start_page
        )
    }
}
